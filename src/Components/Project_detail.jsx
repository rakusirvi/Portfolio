  ...
  return (
    <div className="w-full px-6 md:px-10 lg:px-20 my-5 flex flex-col items-center gap-8">
      ...
      <div className="flex flex-col md:flex-row  justify-center gap-6">
        <img
          className="w-full md:w-1/2 h-auto rounded-xl shadow-lg hover:shadow-2xl transition-transform duration-300 hover:scale-105"
          src={project.img1}
          alt={project.title}
        />
        {project.img2 && (
          <img
            className="w-auto md:w-auto h-64 max-md:h-64 max-md:w-fit rounded-xl shadow-lg hover:shadow-2xl transition-transform duration-300 hover:scale-105"
            src={project.img2}
            alt={project.title}
          />
        )}
          ...
          <div className="flex items-center gap-2">
            <span
              className={`h-5 w-7 rounded-full ${
                project.projectTimeline.toLowerCase() === "pending"
                  ? " bg-red-600"
                  : "bg-yellow-300"
              }`}
            ></span>
