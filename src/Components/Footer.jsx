...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-row  max-md:flex-col text-center justify-around w-full ">
        <div className="m-auto w-full">
          <h1 className="font-medium text-3xl">
            <span className="text-primary-dull">Rakesh </span> Choudhary
          </h1>
        </div>
        <div className="flex flex-col w-full items-center  py-16 text-sm text-gray-800/70">
          <div className="flex items-center gap-8">
            <a
              href="#"
              className="font-medium text-white hover:text-primary-dull transition-all"
            >
              Home
            </a>
            <a
      ...
      <p className="mb-2 text-center text-primary/40 max-md:text-[10px]">
        Copyright © 2025 <a href="#">Rakesh Choudhary</a>. All rights
        reservered.
      </p>
    </>
  );
